...
function Head (props){
    return (<div className="flex border-b  shadow-lg justify-between ">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
        ...
        <input className=" placeholder:text-gray-700 block bg-slate-200 w-96  h-10 border  rounded-md py-2 pl-10 pr-3  focus:outline-none focus:border-blue-900  sm:text-sm" placeholder="Recherche " type="text" name="search"/>
      </label>
      </div>
