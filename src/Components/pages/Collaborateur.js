...
function Collaborateur (){
    ...
    <h1 className="text-sky-900 text-2xl font-medium ">COLLABORATEURS</h1>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
    ...
    <div className=" mt-6 p-28 flex-col flex items-center justify-center ">
        <img src="doc5.svg" alt=""/> 
        <p className="text-gray-500 m-4 text-xl"> Vous n'avez  aucun Collaborateur</p>
         </div>
</div>);
}
